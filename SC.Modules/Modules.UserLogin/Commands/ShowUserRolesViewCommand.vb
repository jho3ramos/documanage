...
Namespace Modules.UserLogin.Commands
    ...
    Public Class ShowUserRolesViewCommand
        Inherits ViewModelBase
        Implements ICommand

        Private _viewModel As UserRolesViewModel
...
#Region "ICommand Members"
        ...
        Public Sub Execute(parameter As Object) Implements ICommand.Execute
            ...
            ' show Workspace
            Dim userRolesWorkspace = New Uri("UserRolesView", UriKind.RelativeOrAbsolute)
            iRegionManager.RequestNavigate(RegionNames.MainRegion, userRolesWorkspace, AddressOf NavigationCompleted)
