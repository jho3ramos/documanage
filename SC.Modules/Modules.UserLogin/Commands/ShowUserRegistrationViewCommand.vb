...
Namespace Modules.UserLogin.Commands
    ...
    Public Class ShowUserRegistrationViewCommand
...
#Region "ICommand Members"
        ...
        Public Sub Execute(parameter As Object) Implements ICommand.Execute
            ...
            ' show Workspace
            Dim userRegistrationWorkspace = New Uri("UserRegistrationView", UriKind.RelativeOrAbsolute)
            iRegionManager.RequestNavigate(RegionNames.MainRegion, userRegistrationWorkspace, AddressOf NavigationCompleted)
