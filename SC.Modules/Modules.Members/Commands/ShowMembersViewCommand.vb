...
Namespace Modules.Members.Commands
    ...
    Public Class ShowMembersViewCommand
        Implements ICommand
...
#Region "ICommand Members"
        ...
        Public Sub Execute(parameter As Object) Implements ICommand.Execute
            ...
            ' show Workspace
            Dim membersWorkspace = New Uri("MembersView", UriKind.RelativeOrAbsolute)
            iRegionManager.RequestNavigate(RegionNames.MainRegion, membersWorkspace, AddressOf NavigationCompleted)
